...
const addItemsHandler = async (req, res) => {
    try {
        const { itemCode, itemName, buyPrice, sellPrice, itemStok, sellerName, expiredDate } = req.body;
        const id = nanoid();
...
module.exports = { getAllItemsHandler, addItemsHandler, getItemByIdHandler, updateItemHandler, deleteItemHandler };